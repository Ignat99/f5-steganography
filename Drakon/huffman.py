...
class Huffman(object):
    ...
    def init_huf(self):
        ...
        self.cal(self.BITS_DC_LUMINANCE,   self.VAL_DC_LUMINANCE,   self.dc_matrix[0])
        self.cal(self.BITS_AC_LUMINANCE,   self.VAL_AC_LUMINANCE,   self.ac_matrix[0])
        self.cal(self.BITS_DC_CHROMINANCE, self.VAL_DC_CHROMINANCE, self.dc_matrix[1])
        self.cal(self.BITS_AC_CHROMINANCE, self.VAL_AC_CHROMINANCE, self.ac_matrix[1])
